<div align="center">
  ...
  <h1>Cardinal</h1>
  <p>Das schnellste Dateisuch-Tool für macOS.</p>
  <p>
    <a href="#cardinal-verwenden">Cardinal verwenden</a> ·
    <a href="#cardinal-bauen">Cardinal bauen</a>
  </p>
  <img src="doc/UI.gif" alt="Vorschau der Cardinal-Oberfläche" width="720">
</div>
...
Den vollständigen Operator-Katalog (Boolesche Gruppierung, Ordner-Scopes, Erweiterungsfilter, Regex-Nutzung und mehr Beispiele) findest du in [`doc/search-syntax.md`](doc/search-syntax.md).

...
- تتم المطابقة حسب **مكوّنات المسار**: الكلمات والعبارات والبدائل تطابق اسم الملف أو المجلد نفسه؛ والرموز المفصولة بـ `/` تطابق سلسلة متجاورة من مكوّنات المسار وتعيد العنصر الذي يطابق آخر مقطع.
...
أمثلة سريعة:
```text
report draft                  # ملفات أو مجلدات يحتوي اسمها نفسه على “report” و“draft” معًا
...
- الرمز بدون اقتباس هو **مطابقة جزء من السلسلة** في مكوّن مسار واحد:
...
#  عناصر يحتوي اسمها نفسه على “Application Support”
"Application Support"

...
- Сопоставление ориентировано на **компоненты пути**: слова, фразы и подстановки совпадают с собственным именем файла или папки; токены, разделённые `/`, совпадают с непрерывной цепочкой компонентов пути и возвращают элемент, совпавший с последним сегментом.
...
- Токен без кавычек — это **поиск по подстроке** в одном компоненте пути:

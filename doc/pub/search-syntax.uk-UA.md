...
- Зіставлення орієнтоване на **компоненти шляху**: слова, фрази й підстановки збігаються з власною назвою файла або папки; токени, розділені `/`, збігаються з неперервним ланцюжком компонентів шляху й повертають елемент, що збігся з останнім сегментом.
...
Швидкі приклади:
```text
report draft                  # файли або папки, власна назва яких містить і “report”, і “draft”
...
- Токен без лапок — це **пошук за підрядком** в одному компоненті шляху:
...
#  Елементи, власна назва яких містить “Application Support”
"Application Support"

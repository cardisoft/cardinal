...
- मिलान **पाथ कंपोनेंट** के आधार पर होता है: शब्द, वाक्यांश और वाइल्डकार्ड फ़ाइल या फ़ोल्डर के अपने नाम से मैच करते हैं; `/` से अलग किए गए टोकन लगातार पाथ कंपोनेंट की श्रृंखला से मैच करते हैं और अंतिम सेगमेंट से मेल खाने वाला आइटम लौटाते हैं।
...
- बिना उद्धरण वाला टोकन एक पाथ कंपोनेंट पर **सब‑स्ट्रिंग मैच** होता है:

...
import { type VirtualGridHandle, VirtualGrid } from './VirtualGrid';
import { FileGridItem } from './FileGridItem';
import { GRID_SPACING_X, GRID_SPACING_Y } from '../constants';
      ...
      <div className="flex-fill">
        {displayState !== 'results' ? (
          ...
          <VirtualGrid
            ...
            itemWidth={iconSize + GRID_SPACING_X}
            itemHeight={iconSize + GRID_SPACING_Y}
